...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with Wizebay for wholesale tech enquiries and quotes.",
};
            ...
            <div>
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <textarea rows={4} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"></textarea>
                </div>
                <button type="submit" className="w-full py-2.5 bg-orange-600 text-white font-medium rounded-lg hover:bg-orange-500">
                  Send Message
                </button>
              </form>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { t: "Email", v: "info@wizebay.com", d: "Response within 24 hours" },
                    { t: "Address", v: "45 Avenue Louise, Brussels 1050", d: "Belgium" },
                    { t: "Hours", v: "Monday - Friday", d: "9:00 AM - 6:00 PM CET" },
                  ].map((c, i) => (
                    <div key={i} className="p-4 bg-gray-50 rounded-lg">
                      <h3 className="font-semibold text-gray-900">{c.t}</h3>
                      <p className="text-orange-600">{c.v}</p>
